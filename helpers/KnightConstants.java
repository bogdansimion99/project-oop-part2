...
public final class KnightConstants {
    ...
    public static final int ADDED_DAMAGE_SLAM = 40;
    public static final float INITIAL_HP_LIMIT = 0.2f;
    public static final float ADDED_HP_LIMIT = 0.01f;
    public static final float MAXIMUM_HP_LIMIT = 0.4f;
    public static final int NO_ROUND_PARALYSIS = 1;
    public static final float MODIFICATORS_ADDED = 0.5f;
